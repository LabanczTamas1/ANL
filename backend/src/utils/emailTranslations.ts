...
export const translations = {
  english: {
    ...
    timezone: 'Timezone:',
    instructions:
      'Please click the link a few minutes before the scheduled time to join the meeting.',
  },
  magyar: {
    ...
    timezone: 'Időzóna:',
    instructions:
      'Kérjük, kattintson a linkre néhány perccel a megbeszélt időpont előtt a csatlakozáshoz.',
  },
  romanian: {
    ...
    timezone: 'Fus orar:',
    instructions:
      'Vă rugăm să faceți clic pe link cu câteva minute înainte de ora programată pentru a vă alătura întâlnirii.',
  },
} as const;
